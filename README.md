...
Hi! I'm Justin. I completed all requirements! Except for the domain, as I do not have money for one. Cookies expire 24 hours!
...
### 1. Request the URLs from the API - DONE
...
### 1. Register a workers.dev subdomain - DONE
...
### 2. A user should be able to visit the deployed version of the site - DONE
...
### 3. Publish to a domain - NO DOMAIN
